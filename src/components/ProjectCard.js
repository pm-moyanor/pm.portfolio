      ...
      >
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              <div className="pb-4">
                <h4 className="text-black leading-tight text-sm sm:text-sm md:text-xl lg:text-2xl">
                  {label}
                </h4>
                <h3 className=" leading-none text-black text-[1.8rem] md:text-[4rem] font-extrabold mb-8">
                  {title}
                </h3>
              </div>
