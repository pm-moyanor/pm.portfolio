...
function AboutMe({ getRandomColor }) {
  const text = `I'm a frontend developer. I blend creativity, meticulous attention to detail, and problem-solving skills to craft responsive, user-centric web applications using HTML, CSS, JavaScript, and React.
